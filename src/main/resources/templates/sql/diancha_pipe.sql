...
Date: 2019-06-22 18:28:13
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for diancha_pipe
-- ----------------------------
DROP TABLE IF EXISTS `diancha_pipe`;
CREATE TABLE `diancha_pipe` (
  `dc_pipe_id` int(12) NOT NULL AUTO_INCREMENT,
  `pipe_no` varchar(255) DEFAULT NULL,
  `inves_node_id` int(12) DEFAULT NULL,
  ...
  PRIMARY KEY (`dc_pipe_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of diancha_pipe
-- ----------------------------
