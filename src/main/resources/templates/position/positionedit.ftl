...
<body style="background-color: #ecf0f5;">
	...
	<div class="row" style="padding-top: 15px;">
		<div class="col-md-12">
			<!--id="container"-->
			<div class="bgc-w box">
				<form action="positionedit" method="post" onsubmit=";">
					<#if dept??>
						...
						<div class="box-body">
							...
							<div class="row">
								<div class="col-md-6 form-group">
									<label class="control-label"><span>职位名称</span></label> 
								...
								<div class="col-md-6 form-group">
									...
									<#if position??>
										<option value="${(position.dept.deptId)!''}">${position.dept.name}</option>
									</#if>
									<#list depts as dept>
								...
								<input type="hidden" name="deptId" value="${(position.id)!''}">
							</div>
						</div>
					</div>
					<!--盒子尾-->
