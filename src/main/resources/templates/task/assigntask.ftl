...
<body style="background-color: #ecf0f5;">
	<div class="row" style="padding-top: 10px;">
		<div class="col-md-2">
			<h1 style="font-size: 24px; margin: 0;" class="">任务分派</h1>
		</div>
		<div class="col-md-10 text-right">
			<a href="##"><span class="glyphicon glyphicon-home"></span> 首页</a> >
			<a disabled="disabled">任务分派</a>
		</div>
	</div>
	<div class="row" style="padding-top: 15px;">
		<div class="col-md-12">
			<!--id="container"-->
			<div class="bgc-w box">
				<form action="assigntask" method="post" onsubmit=";">
					<#if task??>
						...
						<div class="box-body">
							...
							<div class="row">
								<div class="col-md-6 form-group">
									...
									<input name="content" readonly="readonly" class="form-control" value="${(task.project.projectNo)!''}"/>
								</div>
								<div class="col-md-6 form-group">
									<label class="control-label"><span>任务内容</span></label> 
									<input name="content" readonly="readonly" class="form-control" value="${(task.content)!''}"/>
								</div>
								<div class="col-md-6 form-group">
									<label class="control-label"> <span>接收人</span></label>
