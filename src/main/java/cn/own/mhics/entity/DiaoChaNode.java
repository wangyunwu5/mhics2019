...
@Entity
@Table(name="diaocha_node")
public class DiaoChaNode {

	@Id
	@Column(name="dc_node_id")
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	private Long dcNodeId;
	...
	public String toString() {
		return "DiaoChaNode [dcNodeId=" + dcNodeId + ", workNo=" + workNo + ", drainageAreaCode=" + drainageAreaCode
				+ ", project=" + project + ", nodeNo=" + nodeNo + ", surveyDate=" + surveyDate + ", yearLaid="
				+ yearLaid + ", status=" + status + ", function=" + function + ", nodeType=" + nodeType
				+ ", coverShape=" + coverShape + ", coverType=" + coverType + ", coverDuty=" + coverDuty
				+ ", coverSizec=" + coverSizec + ", coverSizek=" + coverSizek + ", coverLevel=" + coverLevel
				+ ", hinged=" + hinged + ", locked=" + locked + ", shaftSideEntry=" + shaftSideEntry
				+ ", shaftRegularCourse=" + shaftRegularCourse + ", shaftDepth=" + shaftDepth + ", shaftSizec="
				+ shaftSizec + ", shaftSizek=" + shaftSizek + ", chamberSoffit=" + chamberSoffit + ", chamberSteps="
				+ chamberSteps + ", chamberLadders=" + chamberLadders + ", chamberLndgs=" + chamberLndgs
				+ ", chamberSizec=" + chamberSizec + ", chamberSizek=" + chamberSizek + ", toxic=" + toxic + ", vermin="
				+ vermin + ", constructCode=" + constructCode + ", location=" + location + ", locationPhoto="
				+ locationPhoto + ", internalPhoto=" + internalPhoto + ", locationSketch=" + locationSketch
				+ ", planOfMh=" + planOfMh + ", depthOfFlow=" + depthOfFlow + ", depthOfSilt=" + depthOfSilt
				+ ", heightSurch=" + heightSurch + ", mhDepth=" + mhDepth + ", zbx=" + zbx + ", zby=" + zby + ", utr="
				+ utr + ", utl=" + utl + ", utga=" + utga + ", uts=" + uts + ", jetting=" + jetting + ", onSlope="
				+ onSlope + ", slopeNo=" + slopeNo + ", coverCondition=" + coverCondition + ", coverPhoto=" + coverPhoto
				+ ", ladderCondition=" + ladderCondition + ", ladderPhoto=" + ladderPhoto + ", shaftCondition="
				+ shaftCondition + ", shaftPhoto=" + shaftPhoto + ", chamberCondition=" + chamberCondition
				+ ", chamberPhoto=" + chamberPhoto + ", benchingCondition=" + benchingCondition + ", benchingPhoto="
				+ benchingPhoto + ", othersCondition=" + othersCondition + ", othersPhoto=" + othersPhoto
				+ ", cctvCond=" + cctvCond + ", crity=" + crity + ", recordPlanDifference=" + recordPlanDifference
				+ ", idmsManholeId=" + idmsManholeId + ", dsdRef=" + dsdRef + ", remark=" + remark + ", insertDate="
